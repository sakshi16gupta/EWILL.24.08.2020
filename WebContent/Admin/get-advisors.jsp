...
<body>
	<%
		...
		{
			out.println("<script type='text/javascript'>alert('User Added');window.location.href='view-advisors.jsp';</script>");	
		
		}
		else
		{
			out.println("<script type='text/javascript'>alert('User not Added');window.location.href='add-advisors.jsp';</script>");	
		}
	%>
</body>
</html>