			...
			<div class="span12">
				<div class="widget-box">
					<div class="widget-title">
						...
						<h5>Edit Advisors Type</h5>
					</div>
					<div class="widget-content nopadding">
						<form id="form-wizard" class="form-horizontal"
							action="getupdate-advisors-type.jsp" method="post">


							<%
								int pid = Integer.parseInt(request.getParameter("pid")); 
								AdvisorsTypeDao dao = new AdvisorsTypeDao(); 
								java.util.ArrayList<AdvisorsTypePojo> data = dao.Edit(pid); 
								for (AdvisorsTypePojo obj : data) { 
							%>
