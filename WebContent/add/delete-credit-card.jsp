...
<%
	...
	if(dao.Remove(Integer.parseInt(request.getParameter("pid")))>0){
		out.println("<script type='text/javascript'>alert('Record deleted');window.location.href='profile.jsp?username="
				+ request.getParameter("username") + "&userId=" + request.getParameter("userId")
				+ "';</script>");
	}
	else{
