...
<body>
	<%
		ContactsDao dao1 = new ContactsDao();
			...
			{
			out.println(
					"<script type='text/javascript'>alert('Data Added');window.location.href='profile.jsp';</script>");

		} else {
			out.println(
					"<script type='text/javascript'>alert('Data not Added');window.location.href='add-emergency.jsp';</script>");
		}
	%>
</body>
</html>